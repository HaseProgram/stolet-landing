...
function resizeImg() {
    ...
    if(h > maxHeight) {       
        ...
        $('.big-image').css("height", maxHeight + "px");
        $('.big-image img').css("width", maxWidth + "px");    // Scale width based on ratio
    }
...
var initPhotoSwipeFromDOM = function(gallerySelector) {
    ...
    var parseThumbnailElements = function(el) {
        ...
        for(var i = 0; i < numNodes; i++) {       
            ...
            alt = linkEl.childNodes[0].getAttribute('alt');
            // create slide object
            item = {
    ...
    var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
        ...
        $linkclose = "</a>";
        $link = "<a href=\"" + items[index].src + "\" itemprop=\"contentUrl\" >";
        ...
        $('.big-image > figcaption > .description').html(items[index].d);

        $('.big-image > figure > a > img').click(function() {
            options = {
                ...
                getThumbBoundsFn: function(index) {
                    ...
                    var thumbnail = $('.big-image > figure > a > img')[0], // find thumbnail
